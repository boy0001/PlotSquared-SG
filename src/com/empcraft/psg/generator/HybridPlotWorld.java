...
public class HybridPlotWorld extends PlotWorld {
    ...
    public ConfigurationNode[] getSettingNodes() {
        ...
        return new ConfigurationNode[] { 
                new ConfigurationNode("plot.height", HybridPlotWorld.PLOT_HEIGHT_DEFAULT, "Plot height", Configuration.INTEGER, true), 
                new ConfigurationNode("plot.biome", Biome.FOREST, "Plot biome", Configuration.BIOME, true), 
                new ConfigurationNode("plot.size", HybridPlotWorld.PLOT_WIDTH_DEFAULT, "Plot width", Configuration.INTEGER, true), 
                new ConfigurationNode("plot.filling", HybridPlotWorld.MAIN_BLOCK_DEFAULT, "Plot block", Configuration.BLOCKLIST, true), 
                new ConfigurationNode("plot.floor", HybridPlotWorld.TOP_BLOCK_DEFAULT, "Plot floor block", Configuration.BLOCKLIST, true), 
                new ConfigurationNode("wall.block", HybridPlotWorld.WALL_BLOCK_DEFAULT, "Top wall block", Configuration.BLOCK, true), 
                new ConfigurationNode("wall.block_claimed", HybridPlotWorld.CLAIMED_WALL_BLOCK_DEFAULT, "Wall block (claimed)", Configuration.BLOCK, true),
                new ConfigurationNode("wall.block_protected", HybridPlotWorld.CLAIMED_WALL_BLOCK_DEFAULT, "Wall block (protected)", Configuration.BLOCK, true),
                new ConfigurationNode("wall.block_forsale", HybridPlotWorld.CLAIMED_WALL_BLOCK_DEFAULT, "Wall block (forsale)", Configuration.BLOCK, true),
                new ConfigurationNode("wall.block_auction", HybridPlotWorld.CLAIMED_WALL_BLOCK_DEFAULT, "Wall block (auction)", Configuration.BLOCK, true),
                new ConfigurationNode("road.width", HybridPlotWorld.ROAD_WIDTH_DEFAULT, "Road width", Configuration.INTEGER, true),
                new ConfigurationNode("road.height", HybridPlotWorld.ROAD_HEIGHT_DEFAULT, "Road height", Configuration.INTEGER, true), 
                new ConfigurationNode("road.block", HybridPlotWorld.ROAD_BLOCK_DEFAULT, "Road block", Configuration.BLOCK, true), 
                new ConfigurationNode("wall.filling", HybridPlotWorld.WALL_FILLING_DEFAULT, "Wall filling block", Configuration.BLOCK, true), 
